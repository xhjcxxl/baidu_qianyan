...
def main(args):
    ...
    scheduler = transformers.get_linear_schedule_with_warmup(optimizer, num_warmup_steps=0.5, num_training_steps=len(train_loader) * args.epochs)
...
if __name__ == "__main__":
    ...
    # -------------------- 模型相关 ------------------- #
    args.bert_path = '/home/xiaxiaolin/kg/pretrained_model/bert_torch/chinese_roberta_wwm_ext_torch/'
