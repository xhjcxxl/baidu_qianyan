...
if __name__ == "__main__":
    ...
    # args.merge_file = '../dataset/' + using_dataset + '/merge_train.tsv'
    ...
    for i in range(1, args.nflod+1):
        print("当前是: ", i)
        args.train_file = '../dataset/' + using_dataset + '/split_train_' + str(i) + '.tsv'
        args.dev_file = '../dataset/' + using_dataset + '/split_dev_' + str(i) + '.tsv'
        args.target_dir = 'output/' + using_dataset + '/split_' + str(i)
