...
class Seq2SeqEncoder(nn.Module):
    """
    这里是将LSTM 和 GRU 封装了一遍，在底层的encoder还是调用了对应的LSTM或者GRU
    seq2seq编码器，主要是使用LSTM或者GRU来做编码器
    """
    ...
    def __init__(self, rnn_type, input_size, hidden_size, num_layers=1, bias=True, dropout=0.0, bidirectional=False):
        ...
        self.rnn_type = rnn_type  # LSTM 或者 GRU
        ...
        # input_size是 embedding的维度，hidden_size是lstm输出的embedding维度，num_layers是叠加了多少层
